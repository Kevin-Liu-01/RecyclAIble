  ...
  return (
    <div className="col-span-3 relative flex justify-center  bg-gradient-to-b to-plantGreenDark from-plantGreen rounded-2xl  drop-shadow-lg  overflow-hidden ">
      ...
      <div className="justify-center mx-auto z-10">
        ...
        <div className="mb-9 mx-8 relative grid grid-cols-6 gap-4 px-4 py-4 rounded-xl  mt-9 drop-shadow-lg text-plantGreenLight   leading-8 font-bold tracking-tight  bg-plantGreen border-4 border-plantGreenLight overflow-hidden">
          ...
          <div className="relative z-20 col-span-3 ">
            <div className="bg-gradient-to-b to-plantGreenDark from-plantGreen relative border-4 rounded-xl p-4 overflow-hidden">
              ...
              <div className="md:text-2xl text-xl inline">
                of Americans recycle{" "}
              </div>
              <div className="text-sm inline">(2018)</div>.
            </div>
            <div className="bg-gradient-to-b to-plantGreenDark from-plantGreen relative z-20 border-4 rounded-xl p-4 mt-4 ">
          ...
          <div className="bg-gradient-to-b to-plantGreenDark from-plantGreen relative z-20 col-span-3 border-4 rounded-xl p-4 pverflow-hidden flex grow">
